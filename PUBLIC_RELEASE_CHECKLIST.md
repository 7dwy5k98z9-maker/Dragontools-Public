...
Die aktuelle Anwendungsversion ist `9.8.3`. Dieses Release löst bei älteren Versionen einschließlich V9.8.2 den Updatehinweis aus. Nach der Installation meldet sich erst eine höhere Version wieder als Update.
