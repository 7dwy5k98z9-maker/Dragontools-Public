...
Die aktuelle Anwendungsversion ist `9.8.4`. Ein veröffentlichtes Release mit dieser Version löst bei älteren Versionen einschließlich V9.8.3 den Updatehinweis aus. Ein Git-Push allein veröffentlicht noch kein GitHub Release.
