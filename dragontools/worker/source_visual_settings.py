...
from ..core.settings_conversion import DEFAULT_SOURCE_VISUAL_CHECK_BLOCK_PERCENT, DEFAULT_SOURCE_VISUAL_CHECK_ENABLED, DEFAULT_SOURCE_VISUAL_CHECK_FPS, DEFAULT_SOURCE_VISUAL_CHECK_INTERVAL_PERCENT, DEFAULT_SOURCE_VISUAL_CHECK_MIN_HITS, DEFAULT_SOURCE_VISUAL_CHECK_SAMPLE_DURATION_S, SET_KEY_SOURCE_VISUAL_CHECK_BLOCK_PERCENT, SET_KEY_SOURCE_VISUAL_CHECK_ENABLED, SET_KEY_SOURCE_VISUAL_CHECK_FPS, SET_KEY_SOURCE_VISUAL_CHECK_INTERVAL_PERCENT, SET_KEY_SOURCE_VISUAL_CHECK_MIN_HITS, SET_KEY_SOURCE_VISUAL_CHECK_SAMPLE_DURATION_S
