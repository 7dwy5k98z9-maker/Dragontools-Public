...
SET_KEY_METADATA_TMDB_API_KEY = "/".join(("metadata", "tmdb", "api_key"))
SET_KEY_METADATA_TMDB_READ_TOKEN = "/".join(("metadata", "tmdb", "read_access_token"))
SET_KEY_METADATA_TVDB_ENABLED = "metadata/thetvdb/enabled"
SET_KEY_METADATA_TVDB_API_KEY = "/".join(("metadata", "thetvdb", "api_key"))
