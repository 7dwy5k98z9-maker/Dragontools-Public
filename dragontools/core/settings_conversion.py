...
SET_KEY_QUALITY_TARGET_ENABLED = "quality_target/enabled"
SET_KEY_QUALITY_TARGET_VMAF = "quality_target/vmaf"
SET_KEY_QUALITY_TARGET_SAMPLES = "quality_target/samples"
SET_KEY_QUALITY_TARGET_SAMPLE_DURATION = "quality_target/sample_duration_s"
SET_KEY_QUALITY_TARGET_MIN = "quality_target/min_quality"
SET_KEY_QUALITY_TARGET_MAX = "quality_target/max_quality"
DEFAULT_QUALITY_TARGET_ENABLED = False
DEFAULT_QUALITY_TARGET_VMAF = 95.0
DEFAULT_QUALITY_TARGET_SAMPLES = 3
DEFAULT_QUALITY_TARGET_SAMPLE_DURATION_S = 10
DEFAULT_QUALITY_TARGET_MIN = 18
DEFAULT_QUALITY_TARGET_MAX = 30

SET_KEY_SDR_HDR_ENABLED = "sdr_hdr/enabled"
SET_KEY_SDR_HDR_CONTRAST_RECOVERY = "sdr_hdr/contrast_recovery"
SET_KEY_SDR_HDR_BACKEND = "sdr_hdr/backend"
DEFAULT_SDR_HDR_ENABLED = False
DEFAULT_SDR_HDR_CONTRAST_RECOVERY = 0.30
DEFAULT_SDR_HDR_BACKEND = "ffmpeg"
SET_KEY_COMFYUI_BASE_URL = "sdr_hdr/comfyui/base_url"
SET_KEY_COMFYUI_WORKFLOW_PATH = "sdr_hdr/comfyui/workflow_path"
SET_KEY_COMFYUI_MODEL_PROFILE = "sdr_hdr/comfyui/model_profile"
SET_KEY_COMFYUI_MODEL_ROOT = "sdr_hdr/comfyui/model_root"
SET_KEY_COMFYUI_CHECKPOINT = "sdr_hdr/comfyui/checkpoint"
SET_KEY_COMFYUI_AUTO_START = "sdr_hdr/comfyui/auto_start"
SET_KEY_COMFYUI_START_FILE = "sdr_hdr/comfyui/start_file"
SET_KEY_COMFYUI_START_WAIT_SECONDS = "sdr_hdr/comfyui/start_wait_seconds"
DEFAULT_COMFYUI_BASE_URL = "http://127.0.0.1:8188"
DEFAULT_COMFYUI_WORKFLOW_PATH = ""
DEFAULT_COMFYUI_MODEL_PROFILE = "hdrtvdm_lsn_3dm"
DEFAULT_COMFYUI_MODEL_ROOT = ""
DEFAULT_COMFYUI_CHECKPOINT = ""
DEFAULT_COMFYUI_AUTO_START = True
DEFAULT_COMFYUI_START_FILE = ""
DEFAULT_COMFYUI_START_WAIT_SECONDS = 30
